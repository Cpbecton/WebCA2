    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=ie&category=sport">sport in Ireland</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=gb&category=sport">sport in UK</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=us&category=sport">sport in USA</a></li>
        </ul>
