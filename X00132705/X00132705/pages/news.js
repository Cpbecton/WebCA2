    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
          ...
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=gb">Top Headlines UK</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=us">Top Headlines USA</a></li>
        </ul>
        ...
        <div>
          ...
          {this.state.articles.map((article, index) => (
            <section key={index}>
              ...
              <p>{article.content}</p>
              <p><Link href="/article"><a>Read More</a></Link></p>
