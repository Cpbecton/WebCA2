    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
          ...
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=gb&category=business">Business News UK</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=us&category=business">Business News USA</a></li>
        </ul>
