...
// Get your own key!
const apiKey = 'a0fcd3087e5c4d74a8bb9565a30ab785';

// Initial News source
const defaultNewsSource = 'wired';
  ...
  render() {
    ...
    return (
      <div>
        ...
        <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=ie&category=technology">technology in Ireland</a></li>
        <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=gb&category=technology">technology in UK</a></li>
        <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=us&category=technology">technology in USA</a></li>
        </ul>
